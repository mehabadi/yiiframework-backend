...
class ETimeoutDialog extends CJuiWidget {
    ...
    public function init() {
        ...
        $cs->registerScriptFile($assets . '/js/timeout-dialog.js', CClientScript::POS_END);
    ...
    public function run() {
        ...
        Yii::app()->getClientScript()->registerScript('TimeoutDialog', "setTimeout(function() { $.timeoutDialog($options) }, $this->timeout * 1000);", CClientScript::POS_READY);
    }
