...
var scrolltotop={
	...
	controlHTML: '<img src="protect/theme/admin/images/icon/totop.png" style="width:21px; height:21px" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
